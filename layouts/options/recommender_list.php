...
$obj = new Model;
$recommender_list = $obj->recommender();
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Recommender List View</h3>
              </div>
              ...
              <div class="card-body">
                ...
                <a href="add_recommender.php" type="submit" name="save" class="btn btn-sm btn-primary"><i class="fas fa-plus"></i> Add</a>
                </div>
                  <style>
                  table {
                ...
                <?php 
                  ...
                  $no=1;
                  while ($rows = mysqli_fetch_array($recommender_list)) {
                ...
                ?>
                  ...
                  echo "<a onClick=\"javascript: return confirm('Are you sure want to delete this record?');\" class= 'dropdown-item' href='delete.php?fuel_ID=".$rows["recommender_id"]."'>"?><i class="fa fa-trash" style="color:red"></i> Delete</a>
             <?php    } ?>
                    </div>
                    </td> 
                    </tr>
